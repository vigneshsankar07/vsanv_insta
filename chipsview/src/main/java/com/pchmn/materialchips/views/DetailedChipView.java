  ...
  TextView mNameTextView;
   ...
   ImageButton mDeleteButton;
    ...
    private void init(AttributeSet attrs) {
        // inflate layout
        View view = inflate(getContext(), R.layout.detailed_chip_view, this);
        mContentLayout = (LinearLayout)view.findViewById(R.id.content);
        mAvatarIconImageView = (CircleImageView) view.findViewById(R.id.avatar_icon);
