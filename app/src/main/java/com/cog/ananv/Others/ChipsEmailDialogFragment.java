...
public class ChipsEmailDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View view = View.inflate(getContext(), com.doodle.android.chips.R.layout.dialog_chips_email, null);
        ...
        mEditText = (MaterialEditText) view.findViewById(com.doodle.android.chips.R.id.et_ch_email);
        mConfirm = (Button) view.findViewById(com.doodle.android.chips.R.id.bu_ch_confirm);
        mCancel = (Button) view.findViewById(com.doodle.android.chips.R.id.bu_ch_cancel);

        TextView titleView = (TextView) view.findViewById(com.doodle.android.chips.R.id.tv_ch_title);

        mErrorMsg = getString(com.doodle.android.chips.R.string.please_enter_a_valid_email_address);
