...
public class FollowerAdapter extends RecyclerView.Adapter<FollowerAdapter.Customizeview> {
    ...
    public FollowerAdapter(Context context, List<Feedlist> Feedlist, CustomItemClickListener listener) {
    ...
    public Customizeview onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.followerlist, parent, false);
    ...
    private void block_post(String postid, String user_id) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(Constants.LIVEURL)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        RetrofitArrayAPI service = retrofit.create(RetrofitArrayAPI.class);
        Call<List<BlockModel>> call = service.blockPost(postid,user_id);
